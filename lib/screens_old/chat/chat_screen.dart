...
class _ChatScreenState extends State<ChatScreen>
  ...
  void _onControllerChanged() {
    ...
    if (_autoSpeak && _controller != null && !_controller!.typing) {
      ...
      if (msgs.length > _lastSpokenMsgCount && msgs.isNotEmpty) {
        ...
        // Get content safely — works whether ChatMessage is Map or class
        try {
              ...
              actions: [
                ...
                IconButton(
                  icon: Icon(
                    ...
                    color: _autoSpeak ? const Color(0xFFFF6A00) : Colors.grey,
                  ),
                ...
                IconButton(
                    icon: const Icon(Icons.add), onPressed: _createNewChat),
              ],
            )
          : null,
  ...
  Widget _buildSidebarHeader() {
    return Container(
      ...
      decoration: const BoxDecoration(
        gradient:
            LinearGradient(colors: [Color(0xFFFF8A00), Color(0xFFFF6A00)]),
      ),
      child: Row(
        children: [
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color:
                        isActive ? const Color(0xFFFF6A00) : Colors.transparent,
                    width: 2,
                  ),
                ),
                child: Row(
                  ...
                  GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      child: Icon(
                        ...
                        color:
                            _isListening ? Colors.red : const Color(0xFFFF6A00),
                        size: 20,
                      ),
                    ),
                  ),
