// lib/screens/chat/widgets/voice_input_button.dart — Blue Theme
...
class _VoiceInputButtonState extends State<VoiceInputButton>
  ...
  void initState() {
    ...
    _barAnims = _barControllers.map((c) {
      return Tween<double>(begin: 0.2, end: 1.0)
  ...
  void _startBars() {
    for (int i = 0; i < _barCount; i++) {
      Future.delayed(Duration(milliseconds: i * 60), () {
        if (mounted && _listening) _barControllers[i].repeat(reverse: true);
      });
    }
  }
      ...
      GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            color:
                _listening ? const Color(0xFF2979FF) : const Color(0xFF141428),
            border: Border.all(
              color: _listening
